...
def demo_mambo_user_vision_function(mambo):
    ...
    # MinidroneSensors.update()         #->maybe use this function to control error and drift 
    ...
    while flying == True:
        ...
        ans=input("Which direction? (wasd), or type 'done' to land\n")
        ...
        #get EOP parameters 
        # mambo.sensors.set_user_callback_function(mambo, None, "DroneAltitude_altitude")
        # mambo.sensors.update()         #->maybe use this function to control error and drift 
        direction = mambo.sensors.get_estimated_z_orientation()
